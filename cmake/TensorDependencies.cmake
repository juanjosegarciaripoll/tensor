...
function(tensor_find_dependency)
  ...
  set(one_value_args NAME OUTVAR IMPORT_TARGET DEPENDENCIES)
  ...
  if (${cxx_var_name} OR ${ld_var_name})
    ...
    set("${ARGP_OUTVAR}" "${target_name}" PARENT_SCOPE)
  ...
  if (ARGP_CONFIG_NAMES AND ARGP_IMPORT_TARGET)
    foreach(ARGP_CONFIG_NAME ${ARGP_CONFIG_NAMES})
      ...
      if (${ARGP_CONFIG_NAME}_FOUND AND (TARGET "${ARGP_IMPORT_TARGET}"))
        ...
        set("${ARGP_OUTVAR}" "${ARGP_IMPORT_TARGET}" PARENT_SCOPE)
  ...
  if (ARGP_PKGCONFIG_NAMES)
    if (PkgConfig_FOUND)
      ...
      if (${ARGP_NAME}_FOUND)
        ...
        set("${ARGP_OUTVAR}" "PkgConfig::${ARGP_NAME}" PARENT_SCOPE)
