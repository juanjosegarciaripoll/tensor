...
if(BLA_VENDOR MATCHES "Intel" OR BLA_VENDOR STREQUAL "All")
  if(NOT BLAS_LIBRARIES)
    if(CMAKE_C_COMPILER_LOADED OR CMAKE_CXX_COMPILER_LOADED)
      ...
      if(BLAS_LIBRARIES AND BLA_VENDOR STREQUAL "All")
...
if(BLA_F95)
  find_package_handle_standard_args(TensorBLAS REQUIRED_VARS BLAS95_LIBRARIES)
...
if(NOT BLA_F95)
  find_package_handle_standard_args(TensorBLAS REQUIRED_VARS BLAS_LIBRARIES)
endif()

message(STATUS "BLAS Library is ${BLA_VENDOR}")
