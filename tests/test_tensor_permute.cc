      ...
      for (index k = 0; k < a3; k++) {
        switch (code) {
          case 123:
            ...
            break;
          case 133:
            if (A(i, j, k) != P(k, j, i)) return false;
            break;
          case 233:
            if (A(i, j, k) != P(i, k, j)) return false;
            break;
          default:
            error_wrong_code(code);
        }
        ...
        for (index l = 0; l < a4; l++) {
          switch (code) {
            case 124:
              ...
              break;
            case 134:
              if (A(i, j, k, l) != P(k, j, i, l)) return false;
              break;
            case 144:
              if (A(i, j, k, l) != P(l, j, k, i)) return false;
              break;
            case 234:
              if (A(i, j, k, l) != P(i, k, j, l)) return false;
              break;
            case 244:
              if (A(i, j, k, l) != P(i, l, k, j)) return false;
              break;
            case 344:
              if (A(i, j, k, l) != P(i, j, l, k)) return false;
              break;
            default:
              error_wrong_code(code);
          }
          ...
          for (index m = 0; m < a5; m++) {
            switch (code) {
              case 125:
                ...
                break;
              case 135:
                if (A(i, j, k, l, m) != P(k, j, i, l, m)) return false;
                break;
              case 145:
                if (A(i, j, k, l, m) != P(l, j, k, i, m)) return false;
                break;
              case 155:
                if (A(i, j, k, l, m) != P(m, j, k, l, i)) return false;
                break;
              case 235:
                if (A(i, j, k, l, m) != P(i, k, j, l, m)) return false;
                break;
              case 245:
                if (A(i, j, k, l, m) != P(i, l, k, j, m)) return false;
                break;
              case 255:
                if (A(i, j, k, l, m) != P(i, m, k, l, j)) return false;
                break;
              case 345:
                if (A(i, j, k, l, m) != P(i, j, l, k, m)) return false;
                break;
              case 355:
                if (A(i, j, k, l, m) != P(i, j, m, l, k)) return false;
                break;
              case 455:
                if (A(i, j, k, l, m) != P(i, j, k, m, l)) return false;
                break;
              default:
                error_wrong_code(code);
            }
            ...
            for (index n = 0; n < a6; n++) {
              switch (code) {
                case 126:
                  ...
                  break;
                case 136:
                  if (A(i, j, k, l, m, n) != P(k, j, i, l, m, n)) return false;
                  break;
                case 146:
                  if (A(i, j, k, l, m, n) != P(l, j, k, i, m, n)) return false;
                  break;
                case 156:
                  if (A(i, j, k, l, m, n) != P(m, j, k, l, i, n)) return false;
                  break;
                case 166:
                  if (A(i, j, k, l, m, n) != P(n, j, k, l, m, i)) return false;
                  break;
                case 236:
                  if (A(i, j, k, l, m, n) != P(i, k, j, l, m, n)) return false;
                  break;
                case 246:
                  if (A(i, j, k, l, m, n) != P(i, l, k, j, m, n)) return false;
                  break;
                case 256:
                  if (A(i, j, k, l, m, n) != P(i, m, k, l, j, n)) return false;
                  break;
                case 266:
                  if (A(i, j, k, l, m, n) != P(i, n, k, l, m, j)) return false;
                  break;
                case 346:
                  if (A(i, j, k, l, m, n) != P(i, j, l, k, m, n)) return false;
                  break;
                case 356:
                  if (A(i, j, k, l, m, n) != P(i, j, m, l, k, n)) return false;
                  break;
                case 366:
                  if (A(i, j, k, l, m, n) != P(i, j, n, l, m, k)) return false;
                  break;
                case 456:
                  if (A(i, j, k, l, m, n) != P(i, j, k, m, l, n)) return false;
                  break;
                case 466:
                  if (A(i, j, k, l, m, n) != P(i, j, k, n, m, l)) return false;
                  break;
                case 566:
                  if (A(i, j, k, l, m, n) != P(i, j, k, l, n, m)) return false;
                  break;
                default:
                  error_wrong_code(code);
              }
...
void test_permute(Tensor<elt_t> &A) {
  const Indices &dA = A.dimensions();
  {
    ...
    if (dP.size() != dA.size()) abort();
    EXPECT_EQ(dP.size(), dA.size());
    EXPECT_TRUE(std::equal(dP.begin(), dP.end(), dA.begin()));
    if (i == j) {
      EXPECT_TRUE(all_equal(A, P));
    } else {
      int code = (i < j) ? (i + 1) * 100 + (j + 1) * 10 + A.rank()
                         : (j + 1) * 100 + (i + 1) * 10 + A.rank();
      switch (A.rank()) {
        case 2:
          EXPECT_TRUE(eq_permute_2(A, P, code));
          break;
        case 3:
          EXPECT_TRUE(eq_permute_3(A, P, code));
          break;
        case 4:
          EXPECT_TRUE(eq_permute_4(A, P, code));
          break;
        case 5:
          EXPECT_TRUE(eq_permute_5(A, P, code));
          break;
        case 6:
          EXPECT_TRUE(eq_permute_6(A, P, code));
          break;
      }
    }
  }
