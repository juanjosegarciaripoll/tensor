...
const Tensor<elt_t> expm_diag(int n, Tensor<elt_t> *pexponent) {
  /*
...
RTensor pauli_exponential(double theta, double phi, RTensor *pexponent) {
...
CTensor pauli_exponential(double theta, double phi, CTensor *pexponent) {
