...
namespace tensor {
  ...
  template<typename n>
  static void trace_loop(n *C, const n *D, index a1, index a2, index a3, index a4, index a5)
  {
  ...
  static const Tensor<elt_t> do_trace(const Tensor<elt_t> &D, index i1, index i2)
  {
