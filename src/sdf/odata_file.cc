...
void
OutDataFile::dump(const RTensor &t, const std::string &name)
{
...
void
OutDataFile::dump(const CTensor &t, const std::string &name)
{
...
void
OutDataFile::dump(const std::vector<RTensor> &m, const std::string &name)
{
  size_t l = m.size();
...
void
OutDataFile::dump(const std::vector<CTensor> &m, const std::string &name)
{
  size_t l = m.size();
...
void
OutDataFile::dump(const double v, const std::string &name)
{
  RTensor t(1);
  t.at(0) = v;
  dump(t, name);
...
void
OutDataFile::dump(const cdouble v, const std::string &name)
{
  CTensor t(1);
  t.at(0) = v;
  dump(t, name);
...
void
OutDataFile::dump(size_t v, const std::string &name)
{
  dump((double)v, name);
}

void
OutDataFile::dump(int v, const std::string &name)
{
  dump((double)v, name);
}

void
OutDataFile::write_header()
{
  char tag[7] = "sdf  ";
  tag[3] = sizeof(int) + '0';
  tag[4] = sizeof(long) + '0';
